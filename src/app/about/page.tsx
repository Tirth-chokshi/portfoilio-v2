...
export function generateMetadata() {
    return {
        title: "About - Tirth",
        description: "Hi. I'm Tirth chokshi, a self-taught full stack developer from Ahemedabad Gujarat India. I'm a student currently pursuing my bachelors in Computer Application, I love building software that solves real world problems which is probably why everything I build is Open Source.My everyday tech stack includes NEXTJS , Typescript , Tailwind , and so on ....",
        openGraph: {
            images: "https://cdn.discordapp.com/attachments/1079039236302446705/1207210027333718096/Tirth_1.png?ex=65ded0f3&is=65cc5bf3&hm=c511a0d118dae42adfc43114877d0689863f328da2dcc78c02826d271a5cd27f&",
        },
    };
}
        ...
        <section className=" p-4 w-full lg:max-w-[50%] lg:m-auto">
            <div className="flex flex-col gap-4">
                <h1 className=" text-3xl lg:text-5xl font-bold tracking-wide mt-7">
                    Hi. I&apos;m{" "}
                    <a href="https://twitter.com/tirth_chokshi_" rel="noopener noreferrer" target="_blank" className=" text-balance text-blue-500">
                        @Tirth{" "}
                    </a>
                    🤟
                </h1>
                ...
                <p className="text-md lg:text-2xl flex flex-col gap-2 whitespace-break-spaces font-normal">
                    <span>
                        Hey , stranger 👋 I&apos;m Tirth chokshi, a self-taught full stack developer from Ahmedabad Gujarat India. I&apos;m a student currently pursuing my bachelors in <span className=" font-bold">Computer Applications</span>, I love building software that solves real world problems which is probably why everything I build is{" "}
                        <a href="https://github.com/Tirth-chokshi" target="_blank" rel="noopener noreferrer" className=" font-bold text-green-500">
                            Open Source
                        </a>
                        .
                    </span>
                ...
                <div className="flex gap-2 flex-wrap mt-2 mb-2 items-center">
                    ...
                    <a href="https://instagram.com/Tirthhereig" target="_blank" rel="noopener noreferrer">
                ...
                <p className=" text-md lg:text-2xl whitespace-break-spaces font-normal">
                    ...
                    <a href="mailto:chokshitirth4@gmail.com?body=Hello" rel="noopener noreferrer" target="_blank" className=" text-blue-500 italic font-bold">
                        chokshitirth4@gmail.com
                    </a>
                    ) and{" "}
                    <a href="https://twitter.com/tirth_chokshi_" rel="noopener noreferrer" target="_blank" className="font-bold italic text-blue-500">
                        Twitter
                    </a>{" "}
